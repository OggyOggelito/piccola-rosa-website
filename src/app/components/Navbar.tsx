...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 w-full px-4 sm:px-6 md:px-8 py-2 md:py-3 flex items-center justify-between bg-[#FEF6F1]/95 backdrop-blur-md border-b border-[#7A1E2C]/15">
        {/* Logo */}
        <div className="flex items-center">
          <img
            src="/images/nya_npr.png"
            alt="Nya Piccola Rosa"
            className="h-12 md:h-16 w-auto object-contain bg-[#FEF6F1] mix-blend-multiply"
          />
        </div>

        {/* Desktop links */}
        <div className="hidden md:flex gap-8 text-base font-medium text-[#1a1a1a]">
        ...
        <a
          href="/bestall"
          className="hidden md:block bg-[#7A1E2C] text-white px-5 py-2 rounded-full text-sm font-medium hover:bg-[#5c1622] transition whitespace-nowrap"
        >
