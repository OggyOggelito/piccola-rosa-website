...
<nav className="sticky top-0 z-50 w-full px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between bg-[#FEF6F1]/95 backdrop-blur-md border-b border-[#7A1E2C]/15 gap-4">        {/* Logo */}
        ...
        {/* Desktop links */}
        <div className="hidden md:flex items-center gap-8 text-[15px] font-medium text-[#1a1a1a] flex-1 justify-center">
        ...
        <a
          href="/bestall"
          className="hidden md:block bg-[#7A1E2C] text-white px-4 py-2 rounded-full text-xs font-medium hover:bg-[#5c1622] transition whitespace-nowrap shrink-0"
        >
