export default function Hero() {
  return (
    <section
      className="relative min-h-screen md:h-[90vh] flex items-center justify-center text-center px-4 md:px-6 py-28 md:py-0 bg-cover bg-center overflow-hidden"
    ...
    >
      ...
      <div className="relative z-20 max-w-3xl">
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-semibold tracking-wide mb-6 leading-tight text-white">
          Upplev äkta italiensk matkultur
        </h1>

        <p className="text-base sm:text-lg md:text-xl text-gray-200 mb-10 max-w-xl mx-auto">
        ...
        <div className="mt-16 overflow-hidden">
          <div className="flex gap-6 animate-[scroll_25s_linear_infinite]">
            <div className="min-w-[260px] max-w-[260px] sm:min-w-[320px] sm:max-w-[320px] bg-white/5 border border-white/10 rounded-xl p-5 text-left shrink-0 hover:bg-white/10 transition duration-300">
