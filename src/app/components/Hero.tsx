export default function Hero() {
  return (
    <section
      className="relative min-h-[100svh] flex items-center justify-center text-center px-4 md:px-6 pt-28 sm:pt-36 md:pt-32 pb-16 md:pb-20 bg-cover bg-center overflow-hidden"
    ...
    >
      ...
      <div className="relative z-20 max-w-6xl w-full grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
        <div>
        <h1 className="text-[2rem] sm:text-5xl md:text-6xl font-semibold mb-5 leading-[1.1] text-white wrap-break-word px-1 sm:px-2">
        ...
        <div className="mt-8 md:mt-10 grid grid-cols-1 sm:grid-cols-3 gap-0 overflow-hidden rounded-3xl border border-white/10 shadow-2xl bg-white/5 backdrop-blur-sm px-0 max-w-3xl mx-auto">
          <a
            href="/menu#dryck1"
            className="group relative overflow-hidden h-[120px] sm:h-[180px] border-r border-white/10 last:border-r-0"
          >
            <img
        ...
        <div className="mt-8 md:mt-12 overflow-hidden w-full">
          <div className="flex gap-4 sm:gap-6 animate-[scroll_25s_linear_infinite] py-2">
            <div className="min-w-[200px] max-w-[200px] sm:min-w-80 sm:max-w-80 bg-white/5 border border-white/10 rounded-xl p-5 text-left shrink-0 hover:bg-white/10 transition duration-300">
