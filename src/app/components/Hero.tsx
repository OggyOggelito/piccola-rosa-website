export default function Hero() {
  return (
    ...
    >
      {/* Gradient overlay — provides background colour even if image fails */}
      ...
      <div className="relative z-20 max-w-6xl w-full grid lg:grid-cols-2 gap-10 lg:gap-16 items-center text-left">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <div className="w-full grid grid-cols-3 overflow-hidden rounded-2xl border border-white/15 shadow-xl bg-white/5 backdrop-blur-sm">
            <a
              href="/menu#dryck1"
              className="group relative overflow-hidden h-[150px] sm:h-[170px] border-r border-white/15"
            >
              <img
              ...
              <div className="relative z-10 h-full flex items-end p-3 sm:p-4">
                <div>
                  ...
                  <h3 className="text-white text-base sm:text-xl font-semibold leading-tight">Dryckesmeny</h3>
                </div>
              </div>
            </a>
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1555949258-eb67b1ef0ceb?q=80&w=800&auto=format&fit=crop"
                alt="Meny"
                className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition duration-500"
              />
              <div className="absolute inset-0 bg-black/45 group-hover:bg-black/55 transition duration-300" />
              <div className="relative z-10 h-full flex items-end p-3 sm:p-4">
                <div>
                  ...
                  <h3 className="text-white text-base sm:text-xl font-semibold leading-tight">Meny</h3>
                </div>
              </div>
            </a>
            ...
            <a
              href="/sport"
              className="group relative overflow-hidden h-[150px] sm:h-[170px]"
            >
              <img
              ...
              <div className="relative z-10 h-full flex items-end p-3 sm:p-4">
                <div>
                  ...
                  <h3 className="text-white text-base sm:text-xl font-semibold leading-tight">Sport</h3>
                </div>
              </div>
            </a>
          </div>
          ...
          <div className="mt-8 overflow-hidden w-full">
            <div className="flex gap-4 animate-[scroll_30s_linear_infinite] py-2">
              {[
                ...
                "Super trevlig personal. En av de bästa Acapulco pizzorna i västerort!",
                "Trevlig personal. God mat och öl. Veckans tips: Testa deras Biff planka.",
                "Bra service och riktigt god planka!",
                "Grym service och väldigt god mat!",
              ]).map((text, i) => (
                <div
                  key={i}
                  className="min-w-[260px] max-w-[260px] sm:min-w-[300px] sm:max-w-[300px] bg-white/8 border border-white/15 rounded-xl p-4 text-left shrink-0 hover:bg-white/15 transition duration-300"
                >
        ...
        {/* ── RIGHT COLUMN — restaurant image (desktop only) ── */}
        <div className="hidden lg:flex justify-center items-center">
          <div className="relative overflow-hidden rounded-3xl border border-white/15 shadow-2xl w-full max-w-[500px] h-[680px]">
            <img
              src="/images/npr.png"
